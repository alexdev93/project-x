...
const experiences = [
  {
    ...
    title: "Application Administrator & DevOps Engineer",
    company: "Lion International Bank",
    description: `Manage and maintain critical banking applications, ensuring optimal performance and uptime.
                  Implement and monitor CI/CD pipelines using Jenkins for automated deployment.
                  Administer and troubleshoot Docker and Kubernetes environments for containerized applications.
                  Collaborate with cross-functional teams to improve system efficiency and security.
                  Manage and configure Linux-based servers, ensuring system stability and performance.`,
    icon: <Work />,
  },
  {
    ...
    description: `Developed and deployed scalable web applications using React, Node.js, and Express.
