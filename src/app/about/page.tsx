        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="lg:col-span-5">
            <Reveal delay={0.05} direction="none">
              <div className="relative aspect-[4/5] w-full max-w-sm overflow-hidden rounded-[var(--radius-xl)] border border-line bg-gradient-to-b from-accent-soft to-surface-raised">
                <Image
                  src={profile.avatar}
